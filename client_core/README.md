...
- **`client.py`** (저장소 루트) 는 v9 모듈화 이전 호환을 위한 **얇은 shim**.
  ...
  - 학생 PC 배포 시에는 본 파일을 PyInstaller 로 단일 exe 로 빌드한다
    (절차: [`docs/client_deployment.md`](../docs/client_deployment.md)).
...
저장 절차는 [`docs/client_deployment.md`](../docs/client_deployment.md) 와
[`docs/deployment_checklist.md`](../docs/deployment_checklist.md) 참조.
